    ...
    <div className="bg-gray-100">
        <div className="pt-12 sm:pt-16 lg:pt-20">
            <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                Buy Our Product with No Extra Efforts!
                </h2>
                    ...
                    <div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="max-w-lg mx-auto rounded-lg shadow-lg overflow-hidden lg:max-w-none lg:flex">
                            ...
                            <div className="flex items-center">
                                ...
                                FULL UPDATED NEW VERSION OF SMARTWATCH
                                </h4>
                            ...
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                                ...
                                Note App with Voice Activation
                                </p>
                            </li>
                            ...
                            <p className="ml-3 text-sm leading-5 text-gray-700">
                            Fast Photo Taking from Watch Screen
                            </p>
                            </li>
                            <li className="mt-5 flex items-start lg:col-span-1 lg:mt-0">
                            <div className="flex-shrink-0">
                            ...
                            <p className="ml-3 text-sm leading-5 text-gray-700">
                            Selfie App which takes easy selfies from SmartWatch
                            </p>
                            </li>
                            <li className="mt-5 flex items-start lg:col-span-1 lg:mt-0">
                            ...
                            <p className="ml-3 text-sm leading-5 text-gray-700">
                            Live Speaking Weather App with Voice 
                            </p>
                            </li>
                        </ul>
            </div>
...
<section className="h-full py-12 bg-gray-50 overflow-hidden md:py-20 lg:py-24">
  <div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto py-12 px-4 max-w-screen-xl sm:px-6 lg:px-8 lg:py-24">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-3 lg:gap-8">
                <div className="space-y-5 sm:space-y-4">
                    <h2 className="text-3xl leading-9 font-extrabold tracking-tight sm:text-4xl">Meet our leadership</h2>
                    <p className="text-xl leading-7 text-gray-500">We try to offer the best quality with our products. We aim to build best SmartWatches of our century.</p>
                </div>
                <div className="lg:col-span-2">
                    <ul className="space-y-12 sm:grid sm:grid-cols-2 sm:gap-12 sm:space-y-0 lg:gap-x-8">
                        ...
                        <div className="flex items-center space-x-4 lg:space-x-6">
                            ...
                            <div className="font-medium text-lg leading-6 space-y-1">
                                <h4>Dries Vincent</h4>
                                <p className="text-indigo-600">Manager, Business Relations</p>
                            </div>
                        </div>
                        </li>
                        ...
                        <div className="flex items-center space-x-4 lg:space-x-6">
                            ...
                            <div className="font-medium text-lg leading-6 space-y-1">
                                ...
                                <p className="text-indigo-600">Product Developer</p>
                            </div>
                        </div>
                        </li>
                        ...
                        <div className="flex items-center space-x-4 lg:space-x-6">
                            ...
                            <div className="font-medium text-lg leading-6 space-y-1">
                            <h4>Tom Cook</h4>
                            <p className="text-indigo-600">Director, Product Development</p>
                            </div>
                        </div>
                        </li>
                    </ul>
